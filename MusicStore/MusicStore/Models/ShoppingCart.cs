...
namespace MusicStore.Models
{
    public partial class ShoppingCart
    {
        ...
        {
            Cart cartItem = storeDB.Carts.SingleOrDefault(cart => cart.CartId == ShoppingCartId && cart.RecordId == id);
            int itemCount = 0;
        ...
        {
            decimal? total = (from cartItems in storeDB.Carts where cartItems.CartId == ShoppingCartId select (decimal?)cartItems.Count * cartItems.Album.Price).Sum();
